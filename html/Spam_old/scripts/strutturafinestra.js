...
$(function(){
 ...
 $('#Finestra0').dialog({
		position: [(screen.width / 2.7),(screen.height /15)],
		width: 300,
		buttons: {
			"Like":  function() {
...
$('#Finestra1').dialog({
		...
		position: [(screen.width /2),(screen.height /12)],
		width: 300,
		buttons: {
			"Like":  function() {
...
$('#Finestra2').dialog({
		position: [(screen.width / 1.85),(screen.height /10)],
		width: 300,
		buttons: {
			"Like":  function() {
...
$('#Finestra3').dialog({
		position: [(screen.width / 1.7),(screen.height /8)],
		width: 300,
		buttons: {
			"Like":  function() {
...
$('#Finestra4').dialog({
		position: [(screen.width / 4),(screen.height /12)],
		width: 300,
		buttons: {
			"Like":  function() {
                var text =$("#Finestra4").html();
                var path = $(text).attr("about");
                like(path);
            },
			"Dislike": function() {
 ...
 $('#Finestra5').dialog({
		position: [(screen.width / 4.8),(screen.height /10)],
		width: 300,
		buttons: {
			"Like":  function() {
                var text =$("#Finestra5").html();
                var path = $(text).attr("about");
                like(path);
            },
			"Dislike": function() {
  ...
  $('#Finestra6').dialog({
		position: [(screen.width / 6),(screen.height /8)],
		width: 300,
		buttons: {
			"Like":  function() {
                var text =$("#Finestra6").html();
                var path = $(text).attr("about");
                like(path);
            },
			"Dislike": function() {
  ...
  $('#Finestra7').dialog({
		position: [(screen.width / 7.2),(screen.height /3.3)],
		width: 300,
		buttons: {
			"Like":  function() {
                var text =$("#Finestra7").html();
                var path = $(text).attr("about");
                like(path);
            },
			"Dislike": function() {
  ...
  $('#Finestra8').dialog({
		position: [(screen.width / 6.5),(screen.height /3)],
		width: 300,
		buttons: {
			"Like":  function() {
                var text =$("#Finestra8").html();
                var path = $(text).attr("about");
                like(path);
            },
			"Dislike": function() {
  ...
  $('#Finestra9').dialog({
		position: [(screen.width / 1.57),(screen.height /3.5)],
		width: 300,
		buttons: {
			"Like":  function() {
                var text =$("#Finestra9").html();
                var path = $(text).attr("about");
                like(path);
            },
			"Dislike": function() {
 ...
 $('#Finestra10').dialog({
		position: [(screen.width / 1.6),(screen.height /3.15)],
		width: 300,
		buttons: {
			"Like":  function() {
                var text =$("#Finestra10").html();
                var path = $(text).attr("about");
                like(path);
            },
			"Dislike": function() {
 ...
 $('#Finestra11').dialog({
		position: [(screen.width / 2.7),(screen.height /1.7 )],
		width: 300,
		buttons: {
			"Like":  function() {
                var text =$("#Finestra11").html();
                var path = $(text).attr("about");
                like(path);
            },
			"Dislike": function() {
 ...
 $('#Finestra12').dialog({
		position: [(screen.width / 4),(screen.height /1.8 )],
		width: 300,
		buttons: {
			"Like":  function() {
                var text =$("#Finestra12").html();
                var path = $(text).attr("about");
                like(path);
            },
			"Dislike": function() {
 ...
 $('#Finestra13').dialog({
		position: [(screen.width / 4.8),(screen.height /1.9 )],
		width: 300,
		buttons: {
			"Like":  function() {
                var text =$("#Finestra13").html();
                var path = $(text).attr("about");
                like(path);
            },
			"Dislike": function() {
 ...
 $('#Finestra14').dialog({
		position: [(screen.width / 6),(screen.height /2)],
		width: 300,
		buttons: {
			"Like":  function() {
                var text =$("#Finestra14").html();
                var path = $(text).attr("about");
                like(path);
            },
			"Dislike": function() {
	 ...
	 $('#Finestra15').dialog({
		position: [(screen.width /2),(screen.height /1.8)],
		width: 300,
		buttons: {
			"Like":  function() {
                var text =$("#Finestra15").html();
                var path = $(text).attr("about");
                like(path);
            },
			"Dislike": function() {
 ...
 $('#Finestra16').dialog({
		position: [(screen.width / 1.85),(screen.height / 1.9)],
		width: 300,
		buttons: {
			"Like":  function() {
                var text =$("#Finestra16").html();
                var path = $(text).attr("about");
                like(path);
            },
			"Dislike": function() {
...
$('#Finestra17').dialog({
		position: [(screen.width / 1.75),(screen.height /2)],
		width: 300,
		buttons: {
			"Like":  function() {
                var text =$("#Finestra17").html();
                var path = $(text).attr("about");
                like(path);
            },
			"Dislike": function() {
