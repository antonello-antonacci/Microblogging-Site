function sendPost(testoPost){
    ...
    if(testoPost.length<=140 && testoPost.length>0){        
        ...
        while(pos!=-1 && pos!=currentPos){
            ...
            var url = "http://"+escape(media.substring(7,media.length));
            
            var span="";
            if(ext == ".png" || ext==".jpg" || ext==".gif"){
                span = "<span resource=\"image\" src=\""+url+"\"/>";
            }else if(ext == ".mp3" || ext==".m4a" || ext==".ogg" || ext==".wav"){
                span = "<span resource=\"audio\" src=\""+url+"\"/>";
            }else if(ext==".avi" || ext==".3gp" || ext==".wmv" || ext==".mp4"){
                span = "<span resource=\"video\" src=\""+url+"\"/>";
            }else{
                span ="<a href='"+url+"'>"+media+"</a>";
            }
